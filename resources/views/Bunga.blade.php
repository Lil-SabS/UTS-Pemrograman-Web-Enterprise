...
<body id="bd">
    ...
    <div>
        <img id="img1" src="{{ asset('images/flo1.jpg') }}" alt="Flower 1">
        <img id="img2" src="{{ asset('images/flo2.jpg') }}" alt="Flower 2">
        <img id="img3" src="{{ asset('images/flo3.jpg') }}" alt="Flower 3">
    </div>
